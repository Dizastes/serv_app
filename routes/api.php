...
Route::prefix('ref')->group(function () {
    Route::prefix('user')->group(function () {
        ...
        Route::put('{id}/changeUserData', [UserController::class, 'changeUserData'])->middleware('checkPermission:update-user');
        ...
        Route::delete('{id}/role/{role_id}/hard', [UserController::class, 'hardDeleteUserRole'])->middleware('checkRole:update-user');
        Route::delete('{id}/role/{role_id}/soft', [UserController::class, 'softDeleteUserRole'])->middleware('checkRole:update-user');
        Route::post('{id}/role/{role_id}/restore', [UserController::class, 'restoreDeletedUserRole'])->middleware('checkRole:update-user');
